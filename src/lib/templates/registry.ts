...
export const templateRegistry: TemplateDefinition[] = [
  ...
  },
  {
    ...
    category: "email",
    description: "Soft close email showing exact service tiers and pricing: Essential ($200/mo, bi-weekly), Home Watch ($300/mo, weekly), Coastal Elite ($600/mo), On-Call Only ($100 flat), plus the 6/12-month rate locks.",
